    ...
    >
      ...
      <div className="absolute flex flex-col bottom-2 right-2 z-10 gap-2 bg-white/80 dark:bg-gray-900/70 border border-gray-200 dark:border-gray-700 rounded-md px-2 py-1 shadow-sm">
        {currentKey === 'wallpaper' && (
          <Tooltip>
            ...
            <TooltipContent side="left">陀螺仪</TooltipContent>
          </Tooltip>
        )}
        {currentKey !== 'wallpaper' && <Tooltip>
          ...
          <TooltipContent side="left">显示预览</TooltipContent>
        </Tooltip>}
        {(() => {
            ...
            return (
              <Tooltip>
                <Popover open={clockMenuOpen} onOpenChange={setClockMenuOpen}>
                  ...
                  <TooltipContent side="left">时钟</TooltipContent>
                </Popover>
              </Tooltip>
            );
          }
        ...
        <Tooltip>
          ...
          <TooltipContent side="left">边缘参考线</TooltipContent>
        </Tooltip>
        <Tooltip>
          <TooltipTrigger asChild>
            <Button
          ...
          <TooltipContent side="left">裁切到画布</TooltipContent>
        </Tooltip>
      </div>
      ...
      <div className="absolute top-2 right-2 z-10 flex flex-col gap-2">
        ...
        <Tooltip>
          ...
          <TooltipContent side="left">重新居中</TooltipContent>
        </Tooltip>
      </div>
